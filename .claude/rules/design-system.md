...
│   │                 # RuntimeMonogram, CapabilityStack (I-5.6 Phase C — /agents directory dossier atoms)
...
│   │                 #   RightOfReplyForm (I-5.6 Agent Report lifecycle),
│   │                 #   AgentCleanVerdict (I-5.6 Findings-tab clean-pass empty state — `.ar-empty` panel)
