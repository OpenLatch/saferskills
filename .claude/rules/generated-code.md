...
- `services/api/app/generated/rule_content.json` — snake_case backend mirror of the rule-content map, served by `GET /api/v1/rubric/content` for the install CLI's offline finding prose (also `generate-methodology.cjs`, D-05-32)
