...
| 7 | **methodology** | `rubric/<CATEGORY>/<NAME>-NN.md` (YAML frontmatter) | `webapp/src/generated/methodology/index.mdx` + `webapp/src/generated/methodology/rule-count.ts` + `webapp/src/generated/rules/content.ts` (the `RULE_CONTENT` explainable-finding map) | `scripts/generate-methodology.cjs` (validates frontmatter against `schemas/rubric-rule.schema.json`; stamps rubricSha via `git log -n 1 -- rubric/`) |
