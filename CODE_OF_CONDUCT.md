...
SaferSkills adopts the **Contributor Covenant, version 3.0** (July 2025) as our community Code of Conduct, verbatim.

Read the full text at: <https://www.contributor-covenant.org/version/3/0/code_of_conduct.html>.
...
The Contributor Covenant is licensed [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). See the canonical document linked above for the full text, examples of acceptable + unacceptable behavior, the response ladder, and the appeals process.
