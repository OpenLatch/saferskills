...
@register_adapter("claudeskills_info")
class ClaudeSkillsInfoAdapter(SitemapHtmlAdapter):
    """Scrapes claudeskills.info via its sitemap. Config-driven; no per-site code."""
