...
#                deposits a native form for every agent: verbatim SKILL.md for the
#                skills-dir agents (Claude Code, OpenClaw, Codex, Copilot, Gemini),
#                a `.mdc`/rules `.md` for the rules-dir agents (Cursor, Windsurf,
#                Cline), and a shared AGENTS.md/GEMINI.md marker block for
