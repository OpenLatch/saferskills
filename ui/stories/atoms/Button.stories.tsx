...
export const Primary: Story = () => <Button variant="primary">Scan a capability</Button>
...
export const Large: Story = () => <Button size="lg" variant="primary">Scan a capability</Button>
