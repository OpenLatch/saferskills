...
export default function RespondForm({ slug, githubOrg, githubRepo }: Props) {
  ...
  return (
    <div className="verify-rail respond-rail">
      <div className="rail-item active">
        <div className="rail-gutter">
          <span className="rail-node">✓</span>
        </div>
        <div className="rail-card">
          <form className="respond-form" onSubmit={submit}>
            ...
            <p className="form-disclaimer">
              Your response appears publicly on the report next to findings. We don't moderate it
              (except spam / illegal content per ToS). You can edit or delete it later via this
              form.
            </p>
          </form>
        </div>
